<template>
  <div class="default-title">Editores</div>
  ...
  <confirm-dialog
    ...
    message="Você tem certeza que deseja excluir o editor?"
  ></confirm-dialog>
  <person-form-dialog
    ...
    role-id="A296FC56-EF20-4060-A65A-3E1385FF49DE"
    @success="getPersons"
  ></person-form-dialog>
</template>
...
const requestFilters = ref<Filter>({
  ...
  pageSize: 10,
  General: '',
  RoleId: 'A296FC56-EF20-4060-A65A-3E1385FF49DE',
});
