<template>
  <div class="default-title">Operadores</div>
  ...
  <confirm-dialog
    ...
    message="Você tem certeza que deseja excluir o operador?"
  ></confirm-dialog>
  <person-form-dialog
    ...
    role-id="EFCB9598-9AC4-47DE-9A9A-583C5192FACB"
    @success="getPersons"
  ></person-form-dialog>
</template>
...
const requestFilters = ref<Filter>({
  ...
  pageSize: 10,
  General: '',
  RoleId: 'EFCB9598-9AC4-47DE-9A9A-583C5192FACB',
});
